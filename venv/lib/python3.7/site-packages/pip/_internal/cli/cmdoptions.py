...
verbose = partial(
    ...
    action='count',
    default=0,
    help='Give more normal. Option is additive, and can be used up to 3 times.'
)  # type: Callable[..., Option]
...
quiet = partial(
    ...
    default=0,
    help=(
        'Give less normal. Option is additive, and can be used up to 3'
